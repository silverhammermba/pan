...
\section{Knowledge Distribution}\ref{sec:kdist}
...
Because these calculations are done empirically, it is trivial to extend this to
...
in terms of $P(S|\text{$x$ responds to a query})$. We consider not just
the maximum leakage, but the distribution of that leakage in the network i.e.
the difference between one peer knowing a lot about you and many peers knowing a
little about you.
