...
Attribution privacy bears some similarity with differential privacy: both
...
attacker has some control over $r$ and thus $M$. If we have a swarm
of $n$ peers, an attacker can add $b$ malicious peers to the swarm. These
